-- MarketPulse Database Schema (Fixed for Clerk)
...
-- RLS Policies for users table (fixed type conversion)
...
-- RLS Policies for subscriptions table (fixed type conversion)
...
-- RLS Policies for reports table (fixed type conversion)
